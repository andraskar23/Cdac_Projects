...
//	+----+---------------+--------------------+------------+-----------+----------+------------+-----------------+
	...
	@Exclude
	@OneToOne(mappedBy = "user",cascade = CascadeType.ALL) //CascadeType.ALL-> it means that any changes made to the parent entity will be cascaded to its child entities. 
